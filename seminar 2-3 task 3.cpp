...
std::string Wordisimo( const std::string& text ) 
{
    ...
    for( char c : text ) 
    {
        // Избавляемся от пробелов и знаков пунктуации
        ...
        {
            // Добавляем пробел или знак пунктуации в конец слова
...
int main() 
{
    ...
    std::string result = Wordisimo( text );
